export const MIDLANDS_PROVINCES_DEMOGRAPHICS = {
    capital_province: {
        ...
        population: 1500000,
        demographics: { Human: 90, 'High Elf': 5, Dwarf: 3, Other: 2 },
    ...
    yal_belanor: {
        name: "Yal Belanor",
        population: 450000,
        demographics: { Human: 95, 'Half-Elf': 3, Other: 2 },
    ...
    vemillia: {
        name: "Vemilia",
        population: 800000,
        demographics: { Human: 85, Goblin: 8, Dwarf: 5, Other: 2 },
    ...
    ironwood: {
        ...
        population: 250000,
        demographics: { Human: 70, Rakasha: 20, Other: 10 },
    ...
    lockerwood: {
        name: "Lockerwood",
        population: 300000,
        demographics: { Human: 80, Werewolf: 10, Vampire: 5, Other: 5 },
    ...
    yal_central: {
        name: "Yal Central",
        population: 350000,
        demographics: { Human: 92, Toad: 5, Other: 3 },
    ...
    dark_shores: {
        name: "Dark Shores",
        population: 80000,
        demographics: { Human: 60, 'Corsair Kin': 30, Other: 10 },
    ...
    autumnwood: {
        name: "Autumnwood",
        population: 120000,
        demographics: { Human: 60, Mage: 30, 'Fey-touched': 8, Other: 2 },
    ...
    dry_county: {
        name: "Dry County",
        population: 50000,
        demographics: { Human: 75, 'Chaos-touched': 20, Other: 5 },
    ...
    dulgra: {
        name: "Dulgra",
        population: 180000,
        demographics: { Human: 50, Werewolf: 45, Other: 5 },
    ...
    dark_valley: {
        name: "Dark Valley",
        population: 90000,
        demographics: { Werewolf: 80, Human: 15, Other: 5 },
    ...
    gehnsha_glade: {
        name: "Gehnsha Glade",
        population: 150000,
        demographics: { Human: 65, Vampire: 25, 'Dhampir': 5, Other: 5 },
    ...
    jungle_of_thorns: {
        ...
        population: 60000,
        demographics: { Vampire: 70, 'Thralls': 25, Other: 5 },
    ...
    yale_shores: {
        name: "Yale Shores",
        population: 200000,
        demographics: { Human: 88, 'Sea Elf': 5, Other: 7 },
