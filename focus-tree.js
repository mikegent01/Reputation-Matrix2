...
export const TOAD_TIMELINE = [
    ...
    },
    {
        day: 14,
        events: [
            { toadKey: 'dan', focus: "Inspiring Speech", status: "In Progress", description: "Dan is preparing a speech to bolster the morale of all the liberated toads, increasing their resolve against the dangers of the world.", details: "(3 days remaining)" },
            { toadKey: 'toad_lee', focus: "Fortify Position", status: "In Progress", description: "Toad Lee is organizing the construction of makeshift fortifications to make their camp safer from attack.", details: "(5 days remaining)" },
            { toadKey: 'eager', focus: "Set Booby Traps", status: "In Progress", description: "Eager is using scavenged materials to set up a perimeter of alarms and non-lethal traps around the camp.", details: "(4 days remaining)" },
