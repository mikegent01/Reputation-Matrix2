    ...
    pointsOfInterest: [
        {
            ...
            x: 48.00, y: 85.00, type: 'capital_city', subRegion: 'umbar', name: "The City of the Corsairs, Umbar",
        ...
        },
        {
            ...
            x: 47.50, y: 84.50, type: 'library', subRegion: 'umbar', name: "The Great Archives of Umbar",
        ...
        },
        {
            ...
            x: 45.00, y: 82.00, type: 'workshop', subRegion: 'umbar', name: "The Black Shipyards",
        ...
        },
        {
            ...
            x: 50.00, y: 87.00, type: 'market', subRegion: 'umbar', name: "The Grand Bazaar",
        ...
        },
        {
            ...
            x: 52.00, y: 84.00, type: 'castle', subRegion: 'umbar', name: "The Serpent's Spire",
        ...
        },
        {
            ...
            x: 46.00, y: 92.00, type: 'fortress', subRegion: 'umbar', name: "Citadel of the Black Númenóreans",
        ...
        },
        {
            ...
            x: 40.00, y: 94.00, type: 'prison', subRegion: 'umbar', name: "The Slaves' Pits",
        ...
        },
        {
            ...
            x: 54.00, y: 92.00, type: 'temple', subRegion: 'umbar', name: "Temple of the Dark Lord",
        ...
        },
        {
            ...
            x: 49.00, y: 86.00, type: 'inn', subRegion: 'umbar', name: "The Corsair's Flagon",
        ...
        },
        {
            ...
            x: 47.00, y: 95.00, type: 'watchtower', subRegion: 'umbar', name: "The Southern Watchtower",
        ...
        },
        {
            ...
            x: 53.00, y: 88.00, type: 'village', subRegion: 'umbar', name: "The Haradrim Quarter",
        ...
        },
        {
            ...
            x: 42.00, y: 88.00, type: 'landmark', subRegion: 'umbar', name: "The Veiled Guildhouse",
        ...
        },
        {
            ...
            x: 38.00, y: 92.00, type: 'ruins', subRegion: 'umbar', name: "Forgotten Númenórean Tomb",
        ...
        },
        {
            ...
            x: 47.00, y: 81.00, type: 'workshop', subRegion: 'umbar', name: "The Spice Warehouses",
        ...
        },
        {
            ...
            x: 42.00, y: 84.00, type: 'port', subRegion: 'umbar', name: "The Corsair Fleet Anchorage",
        ...
        },
        {
            ...
            x: 44.00, y: 86.00, type: 'barracks', subRegion: 'umbar', name: "The Salt-Caked Barracks",
        ...
        },
        {
            ...
            x: 50.00, y: 94.00, type: 'cave_entrance', subRegion: 'umbar', name: "The Smuggler's Tunnels",
        ...
        },
        {
            ...
            x: 52.00, y: 90.00, type: 'lair', subRegion: 'umbar', name: "The Beast Pits",
        ...
        },
        {
            ...
            x: 49.00, y: 80.00, type: 'ruins', subRegion: 'umbar', name: "Ruins of the Gondorian Embassy",
        ...
        },
        {
            ...
            x: 39.50, y: 90.50, type: 'mages_tower', subRegion: 'umbar', name: "Sorcerer's Tower of the Black Hand",
