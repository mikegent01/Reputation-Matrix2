...
export function zoomToPoi(poi) {
    ...
    if (svg.empty() || !displayArea || !interactiveLayer || !poi) return;
    ...
    // CRITICAL FIX: Use offsetWidth/Height to get the BASE, un-transformed dimensions of the interactive layer.
    // getBoundingClientRect() returns the transformed size, which was causing incorrect calculations.
    const baseLayerWidth = interactiveLayer.offsetWidth;
    const baseLayerHeight = interactiveLayer.offsetHeight;
